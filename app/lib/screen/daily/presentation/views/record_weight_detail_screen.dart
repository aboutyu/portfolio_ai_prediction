...
class RecordWeightDetailScreen extends ConsumerStatefulWidget {
  const RecordWeightDetailScreen({required this.healthLog, super.key});

  final HealthLog healthLog;

  @override
  ConsumerState<RecordWeightDetailScreen> createState() =>
      _RecordWeightDetailScreenState();
}

class _RecordWeightDetailScreenState
    extends ConsumerState<RecordWeightDetailScreen> {
  // 입력 컨트롤러
  ...
  void initState() {
    ...
    _weightController.text = _healthLog.healthValue.toString();
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: context.tr.weightLogRecordTitle,
              suffixText: 'kg',
