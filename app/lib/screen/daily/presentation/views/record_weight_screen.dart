...
class RecordWeightScreen extends ConsumerStatefulWidget {
  const RecordWeightScreen({super.key});

  @override
  ConsumerState<RecordWeightScreen> createState() => _RecordWeightScreenState();
}

class _RecordWeightScreenState extends ConsumerState<RecordWeightScreen> {
  // 입력 컨트롤러
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          RecordTitleWidget(title: context.tr.dailyFloatingWeightText),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: context.tr.weightLogInputHintWeightText,
              suffixText: 'kg',
