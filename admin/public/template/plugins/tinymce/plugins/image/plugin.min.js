tinymce.PluginManager.add('image', function (a) {
  ...
  function e(d) {
      ...
      (a = l.find('#width')[0]),
        ...
        a &&
          ...
          l.find('#constrain')[0].checked() &&
            ...
            d &&
            (o != c
              ? ((d = Math.round((c / o) * d)), isNaN(d) || b.value(d))
              : ((c = Math.round((d / p) * c)), isNaN(c) || a.value(c))),
          (o = c),
          (p = d));
    }
    function f() {
      function b(b) {
        ...
        (b.onload = function () {
          s.width ||
            s.height ||
            !u ||
            t.setAttribs(b, { width: b.clientWidth, height: b.clientHeight }),
            c();
        }),
          (b.onerror = c);
      }
      ...
      j(),
        ...
        a.undoManager.transact(function () {
          ...
          if (
            ...
            s.caption === !1 &&
              t.is(m.parentNode, 'figure.image') &&
              ((c = m.parentNode), t.insertAfter(m, c), t.remove(c)),
            s.caption !== !0)
          )
            b(m);
            ...
            (d = m),
              (m = m.cloneNode(!0)),
              (c = t.create('figure', { class: 'image' })),
              c.appendChild(m),
              c.appendChild(
                t.create('figcaption', { contentEditable: !0 }, 'Caption'),
              ),
              (c.contentEditable = !1);
    ...
    function j() {
      ...
      if (a.settings.image_advtab) {
        ...
        (d = i(d)),
          ...
          l
            .find('#style')
            .value(t.serializeStyle(t.parseStyle(t.serializeStyle(d))));
      }
    }
    function k() {
      if (a.settings.image_advtab) {
        ...
        l.find('#vspace').value(''),
          ...
          l
            .find('#style')
            .value(t.serializeStyle(t.parseStyle(t.serializeStyle(c))));
      }
    }
    var l,
      m,
    ...
    (m = a.selection.getNode()),
      ...
      m &&
        ('IMG' != m.nodeName ||
          m.getAttribute('data-mce-object') ||
          m.getAttribute('data-mce-placeholder')) &&
        (m = null),
      m &&
        ((o = t.getAttrib(m, 'width')),
    ...
    a.settings.image_description !== !1 &&
      v.push({ name: 'alt', type: 'textbox', label: 'Image description' }),
      a.settings.image_title &&
        v.push({ name: 'title', type: 'textbox', label: 'Image Title' }),
      u &&
        v.push({
          type: 'container',
          label: 'Dimensions',
      ...
      v.push(r),
      a.settings.image_caption &&
        tinymce.Env.ceFalse &&
        v.push({ name: 'caption', type: 'checkbox', label: 'Caption' }),
      a.settings.image_advtab
        ? (m &&
            (m.style.marginLeft &&
              m.style.marginRight &&
              m.style.marginLeft === m.style.marginRight &&
              (s.hspace = g(m.style.marginLeft)),
            m.style.marginTop &&
              m.style.marginBottom &&
              m.style.marginTop === m.style.marginBottom &&
              (s.vspace = g(m.style.marginTop)),
            m.style.borderWidth && (s.border = g(m.style.borderWidth)),
            (s.style = a.dom.serializeStyle(
              a.dom.parseStyle(a.dom.getAttrib(m, 'style')),
            ))),
    ...
    function c(a) {
      return function (c) {
        ...
        for (var e, f = c.length; f--; )
          (e = c[f]),
            b(e) &&
              (e.attr('contenteditable', a ? 'false' : null),
