(function (g) {
  'function' === typeof define && define.amd
    ...
    : 'object' === typeof exports
      ? (module.exports = function (i, j, t, u) {
          i || (i = window);
      ...
      if (g.isPlainObject(c)) {
        ...
        if (v) {
          ...
          for (e = f.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== h.indexOf(':') &&
              (l.push({ name: h, value: n }), f.removeAttribute(h));
          }
          e = 0;
          for (h = l.length; e < h; e++)
            (n = c.createAttribute(
              l[e].name.replace(':', '_dt_b_namespace_token_'),
            )),
              (n.value = l[e].value),
        ...
        v &&
          (-1 === f.indexOf('<?xml') &&
            (f = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + f),
          (f = f.replace(/_dt_b_namespace_token_/g, ':')));
        f = f
  ...
  function N(a, b) {
    ...
    for (
      var f = 0, e = a.body.length;
      f < e &&
      !((c = a.body[f][b].toString().length), c > d && (d = c), 40 < d);
      f++
    );
    return 5 < d ? d : 5;
  }
      ...
      J = function (a, b, d) {
        ...
        var c = this,
          ...
          n = function () {
            if (g && G && 'undefined' !== typeof FileReader) {
              ...
              g
                ? (g.location.href = e)
                : h.open(e, '_blank') === o && G && (h.location.href = e);
              c.readyState = c.DONE;
              l();
              B(e);
            }
        ...
        if (O)
          ...
          h.chrome &&
            ...
            ((s = a.slice || a.webkitSlice),
            (a = s.call(a, 0, a.size, 'application/octet-stream')),
            (f = !0));
    ...
    L = function (a, b) {
      for (
        var d = K(b),
          ...
          i = b.header ? h(c.header) + d : '',
          j = b.footer && c.footer ? d + h(c.footer) : '',
          s = [],
          D = 0,
          k = c.body.length;
        D < k;
  ...
  r.ext.buttons.csvHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      !1 !== b
        ? (b || (b = j.characterSet || j.charset), b && (b = ';charset=' + b))
        : (b = '');
      c.bom && (a = '﻿' + a);
  ...
  r.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      c.footer &&
        b.footer &&
        (d(b.footer, f), g('row:last c', e).attr('s', '2'));
      d = p(e, 'cols');
      ...
      for (k = b.header.length; m < k; m++)
        d.appendChild(
          p(e, 'col', {
            attr: { min: m + 1, max: m + 1, width: N(b, m), customWidth: 1 },
          }),
        );
