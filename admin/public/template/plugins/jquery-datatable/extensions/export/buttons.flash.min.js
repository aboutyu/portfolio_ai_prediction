(function (f) {
  ...
  function v(a) {
    n === o &&
      (n =
        -1 ===
        w
          .serializeToString(f.parseXML(p['xl/worksheets/sheet1.xml']))
          .indexOf('xmlns:r'));
      ...
      if (f.isPlainObject(d)) v(d);
        ...
        if (n) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== g.indexOf(':') &&
              (h.push({ name: g, value: q }), c.removeAttribute(g));
          }
          e = 0;
    ...
    y = function (a, b) {
      for (
        var d = b.newline
          ...
          k = b.header ? j(c.header) + d : '',
          m = b.footer && c.footer ? d + j(c.footer) : '',
          l = [],
          u = 0,
          B = c.body.length;
        u < B;
  ...
  i.ext.buttons.excelFlash = f.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      var a = c._flash,
        ...
        i = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            'number' === typeof a[b] ||
            (a[b].match &&
              f.trim(a[b]).match(/^-?\d+(\.\d+)?$/) &&
              !f.trim(a[b]).match(/^0\d+/))
              ? (d = l(g, 'c', {
                  attr: { t: 'n', r: d },
      ...
      c.footer &&
        b.footer &&
        (i(b.footer, e), f('row:last c', g).attr('s', '2'));
      i = l(g, 'cols');
